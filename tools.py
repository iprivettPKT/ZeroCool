...
PACKAGES = {
    ...
    "kerbrute":         {"label": "Kerbrute", "install": "go install github.com/ropnop/kerbrute@latest"},
    "manspider":        {"label": "MANSPIDER (SMB secret search)", "install": "pipx install man-spider"},
    "mysql":            {"label": "MySQL client", "install": "sudo apt-get install -y default-mysql-client"},
    "psql":             {"label": "PostgreSQL client", "install": "sudo apt-get install -y postgresql-client"},
    "redis-cli":        {"label": "redis-tools", "install": "sudo apt-get install -y redis-tools"},
    "mongosh":          {"label": "MongoDB shell", "install": "sudo apt-get install -y mongodb-mongosh"},
    "odat":             {"label": "ODAT (Oracle)", "install": "pipx install odat"},
    "smbclient":        {"label": "smbclient", "install": "sudo apt-get install -y smbclient"},
